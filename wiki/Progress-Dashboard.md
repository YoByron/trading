...
| **Sharpe Ratio** | -16.13 | >1.0 | ⚠️ |
| **Sortino Ratio** | -23.15 | >1.5 | ⚠️ |
| **Volatility (Annualized)** | 0.25% | <20% | ✅ |
| **VaR (95th percentile)** | -0.03% | >-3% | ✅ |
| **Conditional VaR (95th)** | -0.03% | >-5% | ✅ |
...
| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| **Performance Log Completeness** | 72.2% | >95% | ⚠️ |
| **Missing Dates** | 6 | 0 | ⚠️ |
| **Data Freshness** | 0 days old | <1 day | ✅ |
...
| Metric | Value |
|--------|-------|
| **Expected P/L (30d)** | $+4.87 |
| **Forecast Mean** | $100,010.19 |
| **Forecast Std Dev** | $84.12 |
| **5th Percentile** | $99,874.25 |
| **95th Percentile** | $100,145.82 |
| **Risk of Ruin** | 0.00% | ✅ |
