...
from src.utils.news_sentiment import NewsSentimentAggregator, TickerSentiment, SentimentReport
        ...
        "sentiment_by_ticker": {
            ...
            "NVDA": {
                ...
                "sources": {
                    ...
                    "stocktwits": {"score": 78, "messages": 456, "bullish": 320, "bearish": 136},
            ...
            "GOOGL": {
                ...
                "sources": {
                    ...
                    "stocktwits": {"score": 35, "messages": 123, "bullish": 65, "bearish": 58},
            ...
            "AMZN": {
                ...
                "sources": {
                    ...
                    "stocktwits": {"score": -25, "messages": 89, "bullish": 30, "bearish": 59},
            ...
            "QQQ": {
                ...
                "sources": {
                    ...
                    "stocktwits": {"score": 52, "messages": 198, "bullish": 125, "bearish": 73},
            ...
            "VOO": {
                ...
                "sources": {
                    ...
                    "stocktwits": {"score": 48, "messages": 67, "bullish": 42, "bearish": 25},
    ...
    for ticker, data in mock_data["sentiment_by_ticker"].items():
        ...
        for source_name, source_data in data["sources"].items():
            ...
            if articles > 0:
                ...
                print(f"  - {source_name.capitalize()}: {source_score:+.1f} ({messages} messages: {bullish}B/{bearish}B)")
            else:
