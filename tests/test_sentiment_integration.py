...
def test_sentiment_loader():
    ...
    for ticker in test_tickers:
        ...
        print(f"{ticker:<6} | Score: {score:>5.1f} | Confidence: {confidence:<6} | Regime: {regime}")
...
def test_growth_strategy_integration(sentiment_data):
    ...
    print("-" * 80)
    print(f"{'Ticker':<6} | {'Score':>5} | {'Confidence':<6} | {'Expected Modifier':>18} | {'Actual Modifier':>16}")
    print("-" * 80)
    ...
    for ticker, score, confidence, expected_mod in test_cases:
        ...
        print(f"{ticker:<6} | {score:>5.1f} | {confidence:<6} | {expected_mod:>+17.1f} | {actual_mod:>+15.1f} {match}")
    ...
    for ticker, score, confidence, _ in test_cases:
        ...
        print(f"  {ticker:<6}: {final_score:>5.1f} (sentiment modifier: {sentiment_modifier:>+5.1f})")
