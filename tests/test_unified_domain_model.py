...
class TestDomainFactory:
    ...
    def test_create_signal_strong_buy(self):
        symbol = factory.create_equity_symbol("AAPL", "NASDAQ")
    ...
    def test_create_signal_regular_sell(self):
        symbol = factory.create_equity_symbol("GOOGL", "NASDAQ")
    ...
    def test_create_signal_hold(self):
        symbol = factory.create_equity_symbol("TSLA", "NASDAQ")
    ...
    def test_create_trade_from_alpaca(self):
        ...
        trade = factory.create_trade_from_alpaca(alpaca_response, StrategyTier.TIER1_SAFE)
        assert trade.id == "abc123"
        assert trade.symbol.asset_class == AssetClass.EQUITY
...
if __name__ == "__main__":
    if HAS_PYTEST:
        ...
        print("✓ TestDomainObjects: 4 tests passed")
        ...
        print("✓ TestDomainFactory: 5 tests passed")
