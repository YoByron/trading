...
try:
    ...
    response = client.chat.completions.create(
        model="gpt-4o-mini",
        messages=[
            {"role": "system", "content": "You are a trading system analyst for an automated trading bot."},
            {"role": "user", "content": "Analyze SPY (S&P 500 ETF) for potential trading opportunity. Provide brief sentiment: bullish, bearish, or neutral, and why."}
        ],
        max_tokens=200
    )
    ...
    print(f"   https://smith.langchain.com/o/bb00a62e-c62a-4c42-9031-43e1f74bb5b3/projects/p/04fa554e-f155-4039-bb7f-e866f082103b")
