...
def main():
    ...
    parser.add_argument("--lessons-dir", type=str, default="data/backtests", help="Directory with lesson files")
    ...
    parser.add_argument("--output", type=str, default="data/rag_staging", help="Output for manual ingestion")
