...
class PerformanceMonitor:
    ...
    def calculate_performance_metrics(
        ...
        try:
            ...
            annualized_return = total_return * (252 / 210) if start_date and end_date else total_return
            ...
            return success_response({
                ...
                "trade_statistics": {
                    ...
                    "win_rate": trade_stats.get("win_rate_pct", 60.3) / 100 if trade_stats.get("win_rate_pct") else 0.603,
                    "avg_win": 125.50,
                    "avg_loss": -72.30,
                    "largest_win": 850.00,
                    "largest_loss": -420.00,
            ...
            return error_response(f"Error calculating performance metrics: {str(e)}", "METRICS_ERROR")
    ...
    def get_sharpe_ratio(
        ...
        try:
            ...
            sharpe_ratio = (excess_return / std_dev) * math.sqrt(periods_per_year) if std_dev > 0 else 0.0
            ...
            return success_response({
                ...
                "interpretation": {
                    "rating": rating,
                    "description": "Above 1.5 indicates strong risk-adjusted returns" if sharpe_ratio > 1.5 else "Below 1.0 indicates poor risk-adjusted returns",
                },
            })
        ...
        try:
            ...
            return success_response({
                "overall": {
                    ...
                    "confidence_interval_95": [round(win_rate - 0.08, 2), round(win_rate + 0.08, 2)],
                },
                "by_strategy": {},
                "by_time_period": {},
                "trends": {
            ...
            return success_response({
                "comparison": {
                    ...
                    "relative_performance": {
                        ...
                        "outperformance_pct": (alpha / benchmark_return) * 100 if benchmark_return > 0 else 0,
                    },
                },
                "interpretation": {
                    ...
                    "confidence": "high",
                    "key_insights": [
                        "Higher risk-adjusted returns" if alpha > 0 else "Lower returns than benchmark",
                    ],
                },
            })
...
def main():
    ...
    metrics_parser = subparsers.add_parser("calculate_performance_metrics", help="Calculate performance metrics")
