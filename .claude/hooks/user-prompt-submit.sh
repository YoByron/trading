#!/usr/bin/env bash
# Thin feedback detector that routes thumbs signals into the ThumbGate helper.
...
if [[ ${FEEDBACK_TYPE} == "negative" ]]; then
	printf '\n'
	printf '==================================================\n'
	printf 'THUMBS DOWN DETECTED - RECORDING VIA THUMBGATE\n'
	printf '==================================================\n'
	printf '\n'
else
	printf '\n'
	printf '==================================================\n'
	printf 'THUMBS UP DETECTED - RECORDING VIA THUMBGATE\n'
	printf '==================================================\n'
	printf '\n'
fi
