...
class InputTransform:
    def __call__(self, x, actions: chex.Array, policy: chex.Array, axis: str | None) -> chex.Array:
...
class Normalize(InputTransform, hk.Module):
    def __call__(self, x, actions, policy, axis):
        ...
        return EmaNorm(decay_rate=0.99, eps=1e-6, axis=(0, 1), cross_replica_axis=axis)(x)
