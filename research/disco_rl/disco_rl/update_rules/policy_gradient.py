...
class PolicyGradientUpdate(base.UpdateRule):
    ...
    def unroll_meta_net(
        ...
        pg_adv = rollout.value_out.normalized_adv if self._normalize_adv else rollout.value_out.adv
    ...
    def agent_loss(
        ...
        total_loss_per_step = (
            self._pg_cost * pg_loss_per_step + self._entropy_cost * entropy_loss_per_step
        )
