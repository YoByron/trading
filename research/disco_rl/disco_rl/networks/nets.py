...
def get_network(name: str, *args, **kwargs) -> types.PolicyNetwork:
    ...
    module_init_fn, one_step_fn = hk.without_apply_rng(hk.transform_with_state(_agent_step))
...
class MLPHeadNet(hk.Module):
    ...
    def __init__(
        ...
        if model_out_spec:
            ...
            self._model = None
        self._head_w_init = hk_init.TruncatedNormal(head_w_init_std) if head_w_init_std else None
