...
class LSTMModel:
    ...
    def _model_transition_all_actions(self, embedding: hk.LSTMState) -> chex.Array:
        ...
        one_hot_actions = jnp.eye(num_actions).astype(embedding.cell.dtype)  # [A, A]
    ...
    def _model_head_pass(self, transition_output: chex.Array) -> dict[str, chex.Array]:
        ...
        for key, pred_spec in self._out_spec.items():
            ...
            model_outputs[key] = pred.reshape((batch_size, num_actions, *pred_spec.shape))
