...
from disco_rl import optimizers, types
...
class Agent:
    ...
    def initial_learner_state(self, rng_key: chex.PRNGKey) -> LearnerState:
        ...
        return LearnerState(params=params, opt_state=opt_state, meta_state=meta_state)
    ...
    def unroll_net(
        ...
        should_reset = jnp.concatenate((prepend_non_terminal, masks), axis=0, dtype=masks.dtype)
    ...
    def _loss(
        ...
        # Unroll the network.
        agent_out, new_agent_net_state = self.unroll_net(agent_net_params, agent_net_state, rollout)
