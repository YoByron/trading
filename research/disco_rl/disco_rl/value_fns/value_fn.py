...
from disco_rl import optimizers, types, utils
...
class ValueFunction:
    ...
    def get_value_outs(
        ...
        value_net_outputs, _ = hk.BatchApply(
            lambda x: self._value_fn.one_step(value_state.params, value_state.state, x, None)
    ...
    def update(
        ...
        (value_loss, (value_outs, adv_ema_state, td_ema_state)), dv_dparams = jax.value_and_grad(
