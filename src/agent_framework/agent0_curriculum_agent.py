...
class CurriculumState:
    ...
    def evolve_difficulty(self, success_rate: float) -> TaskDifficulty:
        ...
        if success_rate >= 0.8 and self.current_difficulty != TaskDifficulty.FRONTIER:
            ...
            logger.info(
                f"📈 Curriculum evolved: {self.current_difficulty.value} (success_rate={success_rate:.2f})"
            )
        ...
        # If success rate is low, decrease difficulty
            ...
            self.last_evolution = datetime.now().isoformat()
            logger.info(
                f"📉 Curriculum adjusted: {self.current_difficulty.value} (success_rate={success_rate:.2f})"
            )
...
class CurriculumAgent:
    ...
    def __init__(self, storage_dir: Optional[Path] = None):
        ...
        logger.info(
            f"✅ Curriculum Agent initialized (iteration={self.state.iteration}, difficulty={self.state.current_difficulty.value})"
        )
