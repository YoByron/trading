    ...
    def save_graph(self):
        ...
        try:
            ...
            with open(self.persist_path, 'w') as f:
                json.dump(data, f)
            logger.info(f"Saved Knowledge Graph to {self.persist_path} ({self.graph.number_of_nodes()} nodes, {self.graph.number_of_edges()} edges)")
...
def get_knowledge_graph() -> KnowledgeGraph:
    ...
    if _KG_INSTANCE is None:
        ...
        common_tickers = ["AAPL", "MSFT", "GOOGL", "AMZN", "NVDA", "TSLA", "META", "AMD", "INTC", "SPY", "QQQ"]
